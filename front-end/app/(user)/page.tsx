...
export default function Home() {
    ...
    return (
        <section className="flex flex-col h-full items-center justify-center gap-4 py-8 md:py-10">
            <div className="flex flex-row justify-center items-center w-full h-full relative before:absolute before:inset-0 before:bg-[url('/images/bg-img.png')] before:bg-cover before:bg-center before:opacity-25">
